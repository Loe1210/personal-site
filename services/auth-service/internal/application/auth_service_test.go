...
func (f *fakeUserRepository) Login(_ context.Context, username, password string) (*User, []string, error) {
...
func (f *fakeUserRepository) GetByID(_ context.Context, userID int64) (*User, error) {
...
func newFakeUserRepository() *fakeUserRepository {
	return &fakeUserRepository{
		user:  &User{ID: 1, Username: "admin", Nickname: "管理员"},
